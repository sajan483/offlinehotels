...
@Component({
  selector: 'app-requested-history',
  templateUrl: './requested-history.component.html',
  styleUrls: ['./requested-history.component.scss']
})
export class RequestedHistoryComponent implements OnInit {
  shareLinkDatas:any[]=[];
  companies:any[]=[];
