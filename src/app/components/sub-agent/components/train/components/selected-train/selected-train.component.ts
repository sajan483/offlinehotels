...
@Component({
  ...
  styleUrls: ['./selected-train.component.scss']
})
export class SelectedTrainComponent implements OnInit {
  @Output()
  ...
  @Input()
  isOnward = false;
  //ToDo: enable userstate service
  //private userState: UserStateService
  constructor(public trainSearch:TrainSearchService) { }
